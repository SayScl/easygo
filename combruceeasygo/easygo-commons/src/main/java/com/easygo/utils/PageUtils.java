...
public class PageUtils<T> {
    ...
    public PageUtils(Integer pageIndex, Integer pageSize, Integer totalCount, Integer pageCount, List<T> records, List<Integer> numbers, Integer numberStart, Integer numberEnd) {
        this.pageIndex = pageIndex;
        this.pageSize = pageSize;
        this.totalCount = totalCount;
        this.pageCount = pageCount;
